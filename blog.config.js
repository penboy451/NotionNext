...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'PB', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || '简介', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.pengboyu.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'PB', // 网站关键词 英文逗号隔开
